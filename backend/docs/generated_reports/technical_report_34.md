...
1. **Incident ID:** 4  
   ...
   **Root Cause:** Asset Failure Risk  
   **Resolution:** Closed with complete collaboration ledger  
   **GitHub Issue:** [Issue #4](https://github.com/RYees/factory-maintenance-tracking/issues/4)
...
2. **Incident ID:** 3  
   ...
   **Root Cause:** Asset Failure Risk  
   **Resolution:** Closed with complete collaboration ledger  
   **GitHub Issue:** [Issue #3](https://github.com/RYees/factory-maintenance-tracking/issues/3)
...
3. **HPC Degradation and Fan Degradation**  
   **Confidence:** 47%  
   **Evidence:** Matched incident 4138

4. **HPC Degradation and Fan Degradation**  
   **Confidence:** 46%  
   **Evidence:** Matched incident 4143

5. **HPC Degradation and Fan Degradation**  
   **Confidence:** 46%  
   **Evidence:** Matched incident 4073

6. **HPC Degradation and Fan Degradation**  
   **Confidence:** 46%  
   **Evidence:** Matched incident 4176
...
- Archived GitHub Issues: [Issue #4](https://github.com/RYees/factory-maintenance-tracking/issues/4), [Issue #3](https://github.com/RYees/factory-maintenance-tracking/issues/3)
```